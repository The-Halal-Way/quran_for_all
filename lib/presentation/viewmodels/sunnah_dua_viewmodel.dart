  ...
  List<SunnahDuaItem> allItems(BuildContext context) {
    ...
    return [
      ...
      _sunnahItem(
        ...
        accent: MyColors.secondary,
        gradientColors: const [MyColors.secondaryDark, MyColors.tertiary],
        title: l10n.sunnahDuaSiyamSunnahsTitle,
        subtitle: l10n.sunnahDuaSiyamSunnahsSubtitle,
        pointsRaw: l10n.sunnahDuaSiyamSunnahsPointsRaw,
        arabic: l10n.sunnahDuaSiyamArabic,
        pronunciation: l10n.sunnahDuaSiyamPronunciation,
        translation: l10n.sunnahDuaSiyamTranslation,
        practice: l10n.sunnahDuaSiyamSunnahsPractice,
        source: l10n.sunnahDuaSiyamSource,
        isFeatured: true,
      ),
      _sunnahItem(
        context,
