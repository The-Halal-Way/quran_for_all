  ...
  Widget _buildHadithCards() {
    ...
    final cards = <Widget>[
      HadithNavCard(
        ...
        accentColors: HadithCollectionPalette.anNawawiGradient,
        glowColor: HadithCollectionPalette.anNawawiAccent,
        isDark: _isDark,
        cardBg: _cardBg,
        textMain: _textMain,
        textSub: _textSub,
      ...
      HadithNavCard(
        ...
        accentColors: HadithCollectionPalette.fortyShortGradient,
        glowColor: HadithCollectionPalette.fortyShortAccent,
        isDark: _isDark,
        cardBg: _cardBg,
        textMain: _textMain,
        textSub: _textSub,
